...
<img src="Figures/all_back.jpg" alt="Ultrasonic Sensor Back" width="20%">
...
<img src="Figures/ultra_console.png" alt="Ultrasonic Sensor Console" width="20%">
...
<img src="Figures/ultra_exposed.jpg" alt="Ultrasonic Sensor Exposed" width="20%">
<img src="Figures/ultra_encased.jpg" alt="Ultrasonic Sensor Encased" width="20%">
...
<img src="../Project/Concept/wood_drawing.jpg" alt="Wood Drawing" width="20%">
...
- The device moves in response to the remote participant pressing the keyboard or interacting with the graphical interface (and that pretty well and accurately)
...
- If the device were a bit lighter, then the motors could go slower (yes, it's counter-intuitive). After the evaluation, we reduced the speed, but an even slower speed might be desirable.
...
Here are all videos to show the prototype in action (please ignore the beeping sounds of our neighbor's prototype):
